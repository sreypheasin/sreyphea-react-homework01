  ...
  return (
    <div>
        <div className='flex flex-col items-center mb-10'>
          ...
          <p className='opacity-75 leading-10 pl-5 pr-5 text-center'>Thank you for taking time to provide feedback. We appreciate hearing from you and will reveiw you comment carefuly.</p>
          ...
          <form className='w-4/5 bg-white shadow-lg shadow-gray-200 mx-auto items-center p-5 mt-10 rounded-xl border-t-2'>
            ...
            <p className='mt-5 mb-5'>Do you have any suggestion to improve our product and service?</p>
